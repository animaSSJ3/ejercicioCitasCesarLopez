...
public class JwtTokenFilter extends OncePerRequestFilter {
	...
	private void setAuthenticationContext(String token, HttpServletRequest request) {
		DatosUsuariosEntity userDetails = getUserDetails(token);
	...
	private DatosUsuariosEntity getUserDetails(String token) {
		DatosUsuariosEntity userDetails = new DatosUsuariosEntity();
